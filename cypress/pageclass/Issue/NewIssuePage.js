import BaseClass from "../../locators/components/BaseClassPage";
import NewWorkIssue from "../../locators/Issue/CreateNewIssuelocator"

const newissuepage = new NewWorkIssue();

class NewWorkIssuePage extends BaseClass {


  //  create new work to issue   
  createNewWorkIssue(data) {
    BaseClass.typeTitile(data);
    BaseClass.typeDescription(data);
  }
