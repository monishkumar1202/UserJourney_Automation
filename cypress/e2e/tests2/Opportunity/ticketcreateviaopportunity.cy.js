describe('Create Ticket via Opportunity', ()=>{
    ...
    // Create ticket and enter details via opportunity 
        ...
        cy.get('[data-drid="works--create-work-sidebar--shared-template-field-group"]').click()
        cy.get('.select-dropdown__options').contains(oppdetails.Groups).click()

        cy.get('[data-drid="works--create-work-sidebar--shared-template-field-rev_org--account"]').click()  
        cy.get('[class="select-dropdown__options"]').contains(oppdetails.accountcustomer).click()
